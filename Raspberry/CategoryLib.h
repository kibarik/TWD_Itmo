/*
 * A library of functions to interact with categories
 */

#ifndef BUILD_CATEGORYLIB_H_
#define BUILD_CATEGORYLIB_H_
...
/* Structure import
categories.size() - Количество категорий
categories[i].name - Имя категории с индексом i
categories[i].size() - Количество людей в категории с индексом i
